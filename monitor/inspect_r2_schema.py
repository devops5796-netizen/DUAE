...
_FILES_OPTIONAL_SCRAPERS = frozenset({
    ...
    "rental_cars (motors)",
    "motorcycles (motors)",
    "auto_accessories_parts (motors)",
    "heavy_vehicles (motors)",
    "boats (motors)",
    "number_plates (motors)",
    "sale_commercial (property)",
    "sale_land (property)",
    "sale_residential (property)",
    "sale_multiple_units (property)",
    "sale_off-plan (property)",
    "rent_residential (property)",
    "rent_rooms_rent_flatmates (property)",
    "rent_commercial (property)",
    "rent_holiday_homes (property)",
    "rent_short_term_monthly (property)",
    "rent_short_term_daily (property)",
    "electronics (classified)",
    "computers_networking (classified)",
    "business_industrial (classified)",
    "home_appliances (classified)",
    "sports_equipment (classified)",
    "clothing_accessories (classified)",
    "cameras_imaging (classified)",
    "jewelry_watches (classified)",
    "pets (classified)",
    "musical_instruments (classified)",
    "gaming (classified)",
    "baby_items (classified)",
    "toys (classified)",
    "tickets_vouchers (classified)",
    "collectibles (classified)",
    "books (classified)",
    "music (classified)",
    "free_stuff (classified)",
    "lostfound (classified)",
    "dvds_movies (classified)",
    "furniture_home_garden (classified)",
    "mobile_phones_pdas (classified)",
    "auto_services (community)",
    "consultancy_services (community)",
    "domestic (community)",
    "event_entertainment (community)",
    "freelancers (community)",
    "health_wellbeing_services (community)",
    "home_maintenance (community)",
    "movers_removals (community)",
    "other_services (community)",
    "restoration_repairs (community)",
    "tutors_classes (community)",
    "web_computer_services (community)",
    "Jobs (Jobs)",
    "Jobs_Wanted (Jobs)",
})
